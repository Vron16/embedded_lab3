...
HD_PWD='/home/user/embedded_lab3/lab_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_top_ec.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design_top_ec.tcl -notrace
