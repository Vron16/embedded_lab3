...
HD_PWD='/home/user/embedded_lab3/lab_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_top_ec.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_top_ec.tcl
